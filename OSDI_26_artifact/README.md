...
- Run (on server):
    ```bash
    cd /usr/src/OSDI_26_artifact/experiments/fig3/default
    ./enable_arfs_2.sh
    ./run_all_tests.sh
    python3 extract_data.py

    cd /usr/src/OSDI_26_artifact/experiments/fig3/throttle
    ./run_all_tests.sh
    python3 extract_data.py
    ```
...
- run Figure 4(a) (server-side)
    ```bash
    cd /usr/src/OSDI_26_artifact/experiments/fig4/a
    ./enable_arfs_2.sh
    ./default_one_flow.sh
    python3 extract_data.py
    ```
...
- run Figure 4(b),(c)
    ...
    ```bash
    cd /usr/src/OSDI_26_artifact/experiments/fig4/b_c
    ./enable_arfs_2.sh
    ./run_all_tests.sh
    python3 extract_data.py
    ```
...
- restore kernel patch on 192.168.10.213
  ```bash
  cd /usr/src/OSDI_26_artifact/kernel_patch/default
...
- pre-setup on 192.168.10.211
  ```bash
  cd /usr/src/OSDI_26_artifact/experiments/fig13
  ./sepia_with_no_aRFS.sh
  ```

- run Figure 13(a),(b) on 192.168.10.213
  ```bash
  cd /usr/src/OSDI_26_artifact/experiments/fig13/sepia/iperf_sar/
  ./sepia_init.sh
  ./run_all_tests.sh
  python3 extract_data.py
  ```
...
- run Figure 13(c) on 192.168.10.213
  ```bash
  cd /usr/src/OSDI_26_artifact/experiments/fig13/sepia/iperf_sar_missrate/
  ./run_all_tests.sh
  python3 extract_data.py
  ```
...
- pre-setup on 192.168.10.211
  ```bash
  cd /usr/src/OSDI_26_artifact/experiments/fig14
  ./sepia_with_no_aRFS.sh
  ```
...
- run default phase on 192.168.10.213
  ```bash
  cd /usr/src/OSDI_26_artifact/experiments/fig15/iperf_sar/default
  ./enable_arfs_2.sh
  ./run_all_tests.sh 10
  python3 extract_data.py
  ...
  cd /usr/src/OSDI_26_artifact/experiments/fig15/iperf_sar_missrate/default
  ./run_all_tests.sh 10
  python3 extract_data.py
  python3 extract_data.py --aggregate .
  cat flow_averages.csv
...
- pre-setup on 192.168.10.211
  ```bash
  cd /usr/src/OSDI_26_artifact/experiments/fig15/
  ./sepia_with_no_aRFS.sh
  ```

- run sepia phase on 192.168.10.213
  ```bash
  cd /usr/src/OSDI_26_artifact/experiments/fig15/iperf_sar/sepia
  ./sepia_init.sh
  ./run_all_tests.sh 10
  python3 extract_data.py
  python3 extract_data.py --aggregate .
  ...
  cd /usr/src/OSDI_26_artifact/experiments/fig15/iperf_sar_missrate/sepia
  ./run_all_tests.sh 10
  python3 extract_data.py
  python3 extract_data.py --aggregate .
  cat flow_averages.csv
...
- run `Default + Ring Throttling`
  ...
  - run on 192.168.10.213
    ```bash
    cd /usr/src/OSDI_26_artifact/experiments/fig16/Default_Ring_Thrtt
    ./enable_arfs_2.sh
    ./run_all_tests.sh
    python3 extract_data.py
    ```
...
- run `Default`
  ...
  - run on 192.168.10.213
    ```bash
    cd /usr/src/OSDI_26_artifact/experiments/table1/Default
    ./enable_arfs_2.sh
    ./four_flow_test.sh
...
- run `Default w/Ring-Thrtt`
  ...
  - run on 192.168.10.213
    ```bash
    cd /usr/src/OSDI_26_artifact/experiments/table1/Default_Ring_Thrtt
    ./enable_arfs_2.sh
    ./four_flow_test.sh
    cat four_flow_1/imc_read_test.log
    ```
...
- run `Sepia`
  ...
  - pre-setup on 192.168.10.211
    ```bash
    cd /usr/src/OSDI_26_artifact/experiments/table1/Sepia
    ./sepia_with_no_aRFS.sh
    ```
  - run on 192.168.10.213
    ```bash
...
- prepare SPDK link and build (once)
  ```bash
  cd /usr/src/OSDI_26_artifact/experiments/fig17
  ln -sfn ../common/spdk default/spdk
  ln -sfn ../common/spdk sepia/spdk

  cd /usr/src/OSDI_26_artifact/experiments/fig17/default
...
- run `sepia` phase
  ...
  - target setup on 192.168.10.211
    ```bash
    cd /usr/src/OSDI_26_artifact/experiments/fig17/sepia
    cp target_config.sh config.sh
    ./sepia_with_no_aRFS.sh
    ./prepare_env.sh
    ./run_target.sh 0xFFFFFFFFF
...
- run `default` phase
  ...
  - run on 192.168.10.213
    ```bash
    cd /usr/src/OSDI_26_artifact/experiments/fig18/default
    ./run_nginx_POST.sh
...
- run `sepia` phase
  ...
  - pre-setup on 192.168.10.211
    ```bash
    cd /usr/src/OSDI_26_artifact/experiments/fig18/sepia
    ./sepia_with_no_aRFS.sh
    ```
  - run on 192.168.10.213
    ```bash
...
- run `default` phase
  ...
  - server setup on 192.168.10.211
    ```bash
    cd /usr/src/OSDI_26_artifact/experiments/fig19/default
    ./enable_arfs_2.sh
...
- run `sepia` phase
  ...
  - server setup on 192.168.10.211
    ```bash
    cd /usr/src/OSDI_26_artifact/experiments/fig19/sepia
    ./sepia_server.sh
    ./running_memcached.sh
    ```
