...
#sysctl -w net.ipv4.tcp_rmem="4096 131072 2446677" # 14MB
sleep 1
...
ssh "${SSH_USER}@${CLIENT_IP}" -tt "taskset -c 0 iperf3 -c ${SERVER_IP} -t 30 -P 1 -p 5202 -Z" > sender_iperf_1.log &
ssh "${SSH_USER}@${CLIENT_IP}" -tt "taskset -c 1 iperf3 -c ${SERVER_IP} -t 30 -P 1 -p 5203 -Z" > sender_iperf_2.log &
ssh "${SSH_USER}@${CLIENT_IP}" -tt "taskset -c 2 iperf3 -c ${SERVER_IP} -t 30 -P 1 -p 5204 -Z" > sender_iperf_3.log &
ssh "${SSH_USER}@${CLIENT_IP}" -tt "taskset -c 3 iperf3 -c ${SERVER_IP} -t 30 -P 1 -p 5205 -Z" > sender_iperf_4.log &
ssh "${SSH_USER}@${CLIENT_IP}" -tt "taskset -c 4 iperf3 -c ${SERVER_IP} -t 30 -P 1 -p 5206 -Z" > sender_iperf_5.log &
ssh "${SSH_USER}@${CLIENT_IP}" -tt "taskset -c 5 iperf3 -c ${SERVER_IP} -t 30 -P 1 -p 5207 -Z" > sender_iperf_6.log &
sleep 2
...
perf stat -a -C 10 -o 10_cache_miss.log -e "r02d1,r10d1,LLC-loads,LLC-load-misses" -- sleep 27 &


ports=(5202 5203 5204 5205 5206 5207)
sample_interval=0.1
sample_count=200
