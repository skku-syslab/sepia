...
def parse_cache_counters(content):
    ...
    for line in content.splitlines():
        ...
        if event_name in L3_MISS_EVENT_ALIASES:
...
def aggregate_flow_results(result_dirs, output_path=None):
    ...
    with open(output_path, 'w', newline='', encoding='utf-8') as out_file:
        ...
        writer.writerow(["플로우", "샘플수", *numeric_columns])
...
def main():
    ...
    if not experiment_dirs:
        ...
        print("The following files should exist: receiver_iperf_1.log, receiver_util.log")
    ...
    for dir_name, results in sorted_results:
        ...
        llc_loads = results.get('llc_loads', 0)
        
        if llc_loads > 0:
            l3_miss_rate = (l3_misses / llc_loads) * 100
        else:
            l3_miss_rate = 0.0
