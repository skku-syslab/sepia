...
perf stat -a -C 0 -o 0_cache_miss.log -e "LLC-loads,LLC-load-misses" -- sleep 27 & # L3 hit / L3 miss
perf stat -a -C 2 -o 2_cache_miss.log -e "LLC-loads,LLC-load-misses" -- sleep 27 & # L3 hit / L3 miss
perf stat -a -C 4 -o 4_cache_miss.log -e "LLC-loads,LLC-load-misses" -- sleep 27 & # L3 hit / L3 miss
perf stat -a -C 6 -o 6_cache_miss.log -e "LLC-loads,LLC-load-misses" -- sleep 27 & # L3 hit / L3 miss
perf stat -a -C 8 -o 8_cache_miss.log -e "LLC-loads,LLC-load-misses" -- sleep 27 & # L3 hit / L3 miss
