...
#define PAGES_PER_GROUP 256 // 4KB * 128 = 0.5MB ,4KB * 256 = 1MB
...
struct sepia_allocated_page_list {
    ...
    uint64_t ***avail_mask;  // CPU-wise availability mask: [CPU][GROUP][MASKS_PER_GROUP]
};
